    ...
    <div className="container-login100">
      <div className="wrap-login100">
        ...
        <form className="login100-form validate-form">
          <span className="login100-form-title"> NFT based Certificate </span>

          <div className="wrap-input100 validate-input" data-validate="Valid Wallet Address">
            <input className="input100" type="text" name="wallet address" placeholder="Wallet Address" id="wallet" />
          ...
          <div className="wrap-input100 validate-input" data-validate="Course Name is required">
            <input className="input100" type="text" name="name" placeholder="Course Name" id="Course" />
            <span className="symbol-input100">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
